...
def mostrar_album_carpeta():
    ...
    if carpeta_seleccionada:
        ...
        # Obtener la lista de subcarpetas dentro de la carpeta
        subcarpetas = [nombre for nombre in os.listdir(carpeta_seleccionada) if os.path.isdir(os.path.join(carpeta_seleccionada, nombre))]
        
        # Mostrar el álbum de carpetas
        mostrar_carpetas(carpeta_seleccionada, subcarpetas)
...
def mostrar_carpetas(carpeta_padre, subcarpetas):
    ...
    columnas = 4
    filas = (len(subcarpetas) // columnas) + 1

    # Ancho y alto de cada miniatura de carpeta
    miniatura_ancho = 250
    miniatura_alto = 250
